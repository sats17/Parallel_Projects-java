...
public class MainUi {
	...
	//	BankServiceInterface serviceObject = new BankServiceClass();//created object of service class.
		...
		BankServiceInterface serviceObject=context.getBean("BankService",BankServiceClass.class);
			 			...
			 			while(!returnToDashboard) {
			 				...
			 				switch(signInInput) {
			 				 	 ...
			 				 	 case "4":
			 				 		 ...
			 				 		 while(true) { 
			 				 			 try {
			 				 				 if(accountId2.equals(loggedInAccountId)) {
			 				 					 throw new AccountNotFoundException("same account number");
			 				 				 }
